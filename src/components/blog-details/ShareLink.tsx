    ...
    <RevealAnimation delay={0.2}>
      <div className="mx-auto mt-[70px] max-w-[950px] space-y-4">
        ...
        <ul className="flex items-center gap-2.5">
          <li className="group/social-link border-secondary/10 hover:bg-ns-linen hover:border-stroke-10 inline-flex items-center justify-center rounded-full border p-2.5 transition-all duration-300 ease-in-out hover:scale-110 hover:shadow-lg">
            <Link href="https://www.facebook.com" target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 20 20" fill="none">
                <path
                  ...
                  className="fill-secondary transition-all duration-300 ease-in-out group-hover/social-link:fill-white"
                />
              </svg>
            </Link>
          </li>
