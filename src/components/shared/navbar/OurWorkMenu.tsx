...
const OurWorkMenu = ({
  ...
  return (
    <div>
      ...
      <div
        className={cn(
          'fixed top-full left-1/2 z-40 h-4 w-full max-w-[480px] -translate-x-1/2 bg-transparent transition-opacity duration-300',
      ...
      <div
        ...
        <div className="w-[480px] rounded-[24px] border border-secondary/10 bg-white p-5 shadow-[0_20px_50px_-15px_rgba(20,15,35,0.12)]">
